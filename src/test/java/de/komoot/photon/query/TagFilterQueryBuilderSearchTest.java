...
public class TagFilterQueryBuilderSearchTest extends ESBaseTester {
    ...
    public void testFilterWithTagTourismAttraction() throws IOException {
        ...
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withTags(ImmutableMap.of("tourism", valueSet));
    ...
    public void testValueAttraction() throws IOException {
        Client client = getClient();
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withValues("attraction");
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
        assertThat(searchResponse.getHits().getTotalHits(), is(2l));
    ...
    public void testKeyTourism() throws IOException {
        Client client = getClient();
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withKeys("tourism");
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
    ...
    public void testFilterWithoutTagTourismAttraction() throws IOException {
        Client client = getClient();
        Set<String> valueSet = ImmutableSet.of("attraction");
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withoutTags(ImmutableMap.of("tourism", valueSet));
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
    ...
    public void testValueNotInformation() throws IOException {
        Client client = getClient();
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withoutValues("information");
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
    ...
    public void testKeyNotTourism() throws IOException {
        Client client = getClient();
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withoutKeys("tourism");
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
    ...
    public void testKeyTourismAndValueNotInformation() throws IOException {
        Client client = getClient();
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withKeys("tourism").withoutValues("information");
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
    ...
    public void testKeyTourismButValueNotInformation() throws IOException {
        ...
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withTagsNotValues(ImmutableMap.of("tourism", valueSet));
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
        assertThat(searchResponse.getHits().getTotalHits(), is(6l));
    ...
    public void testKeyNotTourismAndKeyNotAmenity() throws IOException {
        Client client = getClient();
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withoutKeys("tourism", "amenity");
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
    ...
    public void testKeyTourismAndKeyNotAmenity() throws IOException {
        Client client = getClient();
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withKeys("tourism").withoutKeys("amenity");
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
        assertThat(searchResponse.getHits().getTotalHits(), is(8l));
    ...
    public void testValueInformationButKeyNotAmenity() throws IOException {
        Client client = getClient();
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withValues("information").withoutKeys("amenity");
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
        assertThat(searchResponse.getHits().getTotalHits(), is(4l));
    ...
    public void testTagNotTourismAttraction() throws IOException {
        ...
        TagFilterQueryBuilder tagFilterQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES).withoutTags(ImmutableMap.of("tourism", attraction));
        QueryBuilder queryBuilder = tagFilterQueryBuilder.buildQuery();
        SearchResponse searchResponse = search(client, queryBuilder);
        assertThat(searchResponse.getHits().getTotalHits(), is(16l));
