...
public class TagFilterQueryBuilderTest {
    ...
    public void testConstructor() throws IOException {
        TagFilterQueryBuilder photonQueryBuilder = PhotonQueryBuilder.builder("berlin", "en", QueryType.PLACES);
    ...
    public void testFrenchConstructor() throws IOException {
        TagFilterQueryBuilder photonQueryBuilder = PhotonQueryBuilder.builder("berlin", "fr", QueryType.PLACES);
        InputStream resourceAsStream = this.getClass().getClassLoader()
